...
function theme_print_page_header_image_meta_box($post) {
	...
	<p class="hide-if-no-js image_control">
		...
		<input type="checkbox" name="theme_header_image_with_flash" value="1" <?php echo $theme_header_image_with_flash; ?> autocomplete="off" />
		<?php echo __("Use flash in header?", THEME_NS); ?>
		<br>
